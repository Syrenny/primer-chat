...
from src.models.embeddings import ValidatedEmbeddingsResponse
...
class Embeddings:
    ...
    async def embed(self, texts: List[str]) -> ValidatedEmbeddingsResponse:
        ...
        return ValidatedEmbeddingsResponse.model_validate(response.model_dump())

    async def embed_one(self, text: str) -> ValidatedEmbeddingsResponse:
